...
docker container run -d -p 80:80 -v  C:/Amit/Work/DockerTraining/caseStudy3/webapp:/usr/share/nginx/html --name case-study-three nginx
...
#docker compose by default creates a network
# by default docker creates 3 networl bidge/bridge, host/host, none/null (name/driver)
# swarm creates docker_gwbridge/bridge ingress/overlay
