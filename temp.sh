...
http {
    ...
    server {
        listen       80;
        listen       [::]:80;
        server_name  amitsaha.com www.amitsaha.com;
        root         /usr/share/nginx/html/docroot/amit;
    ...
    server {
        listen       80;
        listen       [::]:80;
        server_name  richa.com www.richa.com;
        root         /usr/share/nginx/html/docroot/richa;
